...
void contraction30(input_stream_float* __restrict in0, input_stream_float* __restrict in1, output_stream_float* __restrict out) {

    v4float in0_v, in1_v;
    v8float mul_a;
    v4float mul_v;
    v8float out_a;
    v16float Wv = *((v16float*)W30);
    ...
    for (int i = 0; i < 644264; i++) {
        ...
        printf("in0_contraction00_ = %f %f %f %f \n",  ext_elem(in0_v,0), ext_elem(in0_v,1),
                                                        ext_elem(in0_v,2), ext_elem(in0_v,3));
        printf("in1_contraction00_ = %f %f %f %f \n",  ext_elem(in1_v,0), ext_elem(in1_v,1),
                                                        ext_elem(in1_v,2), ext_elem(in1_v,3));                                               
