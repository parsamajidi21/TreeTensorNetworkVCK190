...
simpleGraph() {
           ...
           p_s0 = input_plio::create("StreamIn0", plio_128_bits,"data/input1.txt");
            ...
            p_s_out = output_plio::create("StreamOut0", plio_128_bits,"output1.txt");
            //p_s_out2 = output_plio::create("StreamOut1", plio_128_bits, "output2.txt");
