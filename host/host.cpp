...
int main(int argc, char** argv) {
    ...
    const size_t CHUNK_SIZE = 2577056; 
    ...
    auto DataInput0 = in_buff_1.map<float*>();
    memcpy(DataInput0, input1, cur_bytes);

    auto in_buff_2 = xrt::bo(device, cur_bytes, pl_mm2s_2.group_id(0));
    auto DataInput1 = in_buff_2.map<float*>();
    memcpy(DataInput1, input2, cur_bytes);

    auto in_buff_3 = xrt::bo(device, cur_bytes, pl_mm2s_3.group_id(0));
    auto DataInput2 = in_buff_3.map<float*>();
    memcpy(DataInput2, input3, cur_bytes);

    auto in_buff_4 = xrt::bo(device, cur_bytes, pl_mm2s_4.group_id(0));
    auto DataInput3 = in_buff_4.map<float*>();
    memcpy(DataInput3,  input4, cur_bytes);

    auto in_buff_5 = xrt::bo(device, cur_bytes, pl_mm2s_5.group_id(0));
    auto DataInput4 = in_buff_5.map<float*>();
    memcpy(DataInput4, input5, cur_bytes);

    auto in_buff_6 = xrt::bo(device, cur_bytes, pl_mm2s_6.group_id(0));
    auto DataInput5 = in_buff_6.map<float*>();
    memcpy(DataInput5, input6, cur_bytes);

    auto in_buff_7 = xrt::bo(device, cur_bytes, pl_mm2s_7.group_id(0));
    auto DataInput6 = in_buff_7.map<float*>();
    memcpy(DataInput6, input7, cur_bytes);

    auto in_buff_8 = xrt::bo(device, cur_bytes, pl_mm2s_8.group_id(0));
    auto DataInput7 = in_buff_8.map<float*>();
    memcpy(DataInput7, input8, cur_bytes);

    auto in_buff_9 = xrt::bo(device, cur_bytes, pl_mm2s_9.group_id(0));
    auto DataInput8 = in_buff_9.map<float*>();
    memcpy(DataInput8, input9, cur_bytes);

    auto in_buff_10 = xrt::bo(device, cur_bytes, pl_mm2s_10.group_id(0));
    auto DataInput9 = in_buff_10.map<float*>();
    memcpy(DataInput9, input10, cur_bytes);

    auto in_buff_11 = xrt::bo(device, cur_bytes, pl_mm2s_11.group_id(0));
    auto DataInput10 = in_buff_11.map<float*>();
    memcpy(DataInput10, input11, cur_bytes);

    auto in_buff_12 = xrt::bo(device, cur_bytes, pl_mm2s_12.group_id(0));
    auto DataInput11 = in_buff_12.map<float*>();
    memcpy(DataInput11, input12, cur_bytes);

    auto in_buff_13 = xrt::bo(device, cur_bytes, pl_mm2s_13.group_id(0));
    auto DataInput12 = in_buff_13.map<float*>();
    memcpy(DataInput12, input13, cur_bytes);

    auto in_buff_14 = xrt::bo(device, cur_bytes, pl_mm2s_14.group_id(0));
    auto DataInput13 = in_buff_14.map<float*>();
    memcpy(DataInput13, input14, cur_bytes);

    auto in_buff_15 = xrt::bo(device, cur_bytes, pl_mm2s_15.group_id(0));
    auto DataInput14 = in_buff_15.map<float*>();
    memcpy(DataInput14, input15, cur_bytes);

    auto in_buff_16 = xrt::bo(device, cur_bytes, pl_mm2s_16.group_id(0));
    auto DataInput15 = in_buff_16.map<float*>();
    memcpy(DataInput15, input16, cur_bytes);
    ...
    auto DataOutput = out_buff_1.map<float*>();
    ...
    auto cghdl = xrt::graph(device,uuid,"tree_tensor");
